    ...
    <div class="row px-xl-5">
        <div class="col-lg-8 table-responsive mb-5">
            <table class="table table-light table-borderless table-hover text-center mb-0">
                ...
                if(!is_null($_SESSION['cart_products']) && count($_SESSION['cart_products']))
                {
                    $inClause =' IN ('. implode(",", $_SESSION['cart_products']) .')';
                    $sql = 'SELECT `idArticol`, `numeArticol`, `pretCurentArticol` FROM `tblArticole` WHERE `idArticol`'. $inClause;
                ...
                else
                {
                    ...
                    {
                        if(is_null($_POST['removeProduct'.($_SESSION['cart_products'][$obj->idArticol])]))
                        {
                            echo '<tr>                            
                                        <td class="align-middle"><img src="' . $images[$obj->idArticol - 1] . '" alt="" style="width: 50px;"> ' .$obj->numeArticol. '</td>
                                        <td class="align-middle">' . $obj->pretCurentArticol . '$</td>
                                        <form method="post">
                                            <td class="align-middle"><button class="btn btn-sm btn-danger" name="removeProduct'.($_SESSION['cart_products'][$obj->idArticol]).'" ><i class="fa fa-times"></i></button></td>
                                        </form>
                                    </tr>';
                            $sum += $obj->pretCurentArticol;
                        }
                    }
                }
                $mysqli->close();
