...
<form method="post" autocomplete="off">
    <p>
        <label for="update_name"><b>Nume complet:</label>
        <input type="text" name="update_name" id="update_name" style="width: 250px;">
        <br><br>
        <label for="update_phone"><b>Nr. telefon:</label>
        <input type="text" name="update_phone" id="update_phone" style="width: 250px;">
        <br><br>
        <label for="update_email"><b>E-mail:</label>
        <input type="text" name="update_email" id="update_email" style="width: 250px;">
        <br><br>
    </p>
    <input type="submit" name="UpdateClient" value="Cauta">
</form>
<hr>
...
function SearchClient()
{
    try
    {
        ...
        else
        {
            ...
            {
                printf("%s %s %s %s %s %s %s\n", $obj->numeClient, $obj->telefonClient, $obj->emailClient, $obj->pretComanda, $obj->adresaComanda, $obj->statusComanda, $obj->dataPlasareComanda);
                echo '<br></br>';
            }
        }
        $mysqli->close();
...
{
    global $name, $phone, $email;
    $name=FormatName($_POST['update_client']);
    $phone=trim($_POST['update_phone']);
    ...
    try
    {
        ...
        $sql='UPDATE `tblClienti` SET `numeClient`=?, `telefonClient`=?, `emailClient`=?';
        $mysqli=new mysqli('localhost', 'alex13dumi', 'steaua86.', 'magArtSportiveDB'); //OOP Style
        ...
        echo 'Updated user: ', $name, ' ', $phone,' ', $email;
        $stmt->close();
        $mysqli->close();
